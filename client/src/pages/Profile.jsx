  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form on onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <p className="text-sm self-center">
          {fileUploadError ? (
            ...
            <span className="text-dark-gray">{`Uploading ${filePerc}%`}</span>
          ) : filePerc === 100 ? (
        ...
        <button
          disabled={loading}
          className="bg-secondary text-white p-3 rounded-lg uppercase hover:opacity-90 disabled:opacity-80"
        >
      ...
      <div className="flex justify-between mt-5">
        ...
        <span onClick={handleSignOut} className="text-red-error cursor-pointer">
          Sign Out
        </span>
      </div>
      <p className="text-red-error mt-5">{error ? error : ""}</p>
