      ...
      <form className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1 gap-2">
          ...
          <div className="flex gap-4">
            <input
              className="p-3 border-gray-400 rounded"
              type="file"
              id="images"
              accept="image/*"
              multiple
            />
            <button className="p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-2xl disabled:opacity-80">
              Upload
            </button>
          </div>
          <button className="p-3 bg-buzz-gold text-white rounded-lg uppercase hover: opacity-90 disabled:opacity-80">Create Listing</button>
        </div>
      </form>
    </main>
  );
